...
export const NotificationIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <path
        ...
        stroke="rgba(16,16,16,1)" strokeWidth="4" fill="none"></path>
    </g>
  </svg>
);
...
<svg xmlns="http://www.w3.org/2000/svg"
    ...
    <g>
    <rect width="48" height="48" fill="rgba(16,16,16,1)" fillOpacity="0.01" stroke="none"></rect><path d="M9 18V42H39V18L24 6L9 18Z" fill="none"></path><path d="M9 42V18L4 22L24 6L44 22L39 18V42H9Z" stroke="rgba(16,16,16,1)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none"></path><path d="M19 29V42H29V29H19Z" fill="none" stroke="rgba(16,16,16,1)" strokeWidth="4" strokeLinejoin="round"></path><path d="M9 42H39" stroke="rgba(16,16,16,1)" strokeWidth="4" strokeLinecap="round" fill="none"></path>
    </g>
  </svg>
);

export const PenIcon = ({ size = 24 }) => (
...
export const HandshakeIcon = ({ size = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M11 17a1 1 0 0 1-1 1H7l-3 3"/>
    <path d="M13 17a1 1 0 0 0 1 1h3l3 3"/>
    <path d="M8 12a4 4 0 0 1 8 0"/>
    <path d="M12 4v4"/>
    <line x1="5" y1="9" x2="8" y2="12"/>
    <line x1="19" y1="9" x2="16" y2="12"/>
  </svg>
);
